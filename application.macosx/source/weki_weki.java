...
public class weki_weki extends PApplet {
...
class SoundController {
  ...
  public void update_params( OscMessage msg
    ...
    for (int i = 0; i < hm_waves; i++) {
      ...
      wave.pan(msg.get(item_id+2).floatValue()-0.5f);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "weki_weki" };
    if (passedArgs != null) {
